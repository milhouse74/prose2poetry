...
Sevag created the prose and poetry datasets, the code architecture, the Markov chain generator, the couplet score, and ran the evaluations. François developed the vector embedding models (FastText and doc2vec), the word pair generation, the LSTM generator, and the rhyme score. Sophie participated in overall model design meetings, the discovery of the pronunciation-sense ambiguity problem, and in the proofreading of the final report.
